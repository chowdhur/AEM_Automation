...
public class ExcelLibrary {
	...
	public static void setTestSuiteFile(String testSuitePath) throws Exception {
    	try {
    		...
    		glb_Logger_commonlogs.error("Class :: ExcelLibrary | Method :: setTestSuiteFile | Exception desc : " + e.getMessage());
	...
	public static int getRowCount(String sheetName){
		...
		try {
			...
			glb_Logger_commonlogs.error("Class :: ExcelLibrary | Method :: getRowCount | Exception desc : " + e.getMessage());
			TestSuiteDriver.glb_Boolean_testResult = false;
			}
		return rowCount;
		}
	...
	public static int getRowContains(String testCaseName, int columnNumber,String sheetName) throws Exception{
		...
		try {
			...
			glb_Logger_commonlogs.error("Class :: ExcelLibrary | Method :: getRowContains | Exception desc : " + e.getMessage());
			TestSuiteDriver.glb_Boolean_testResult = false;
			}
		return rowNumber;
		}
	...
	public static int getTestStepsCount(String sheetName, String testCaseId, int testCaseStart) throws Exception{
		try {
			...
			glb_Logger_commonlogs.error("Class :: ExcelLibrary | Method :: getTestStepsCount | Exception desc : " + e.getMessage());
			TestSuiteDriver.glb_Boolean_testResult = false;
			return 0;
        }
	}
	...
	public static void setCellData(String result,  int rowNumber, int columnNumber, String sheetName) throws Exception    {
           try{
               ...
               if (glb_Cell_cell == null) {
            	 ...
            	 glb_Logger_commonlogs.error("Class :: ExcelLibrary | Method :: setCellData | Exception desc : " + e.getMessage());
            	 TestSuiteDriver.glb_Boolean_testResult = false;
	 ...
	 */
	 public static String getCellData(int rowNumber, int columnNumber, String sheetName ) throws Exception{
         try{
             ...
             String CellData = glb_Cell_cell.getStringCellValue();
             return CellData;
          }catch (Exception e){
        	  glb_Logger_commonlogs.error("Class :: ExcelLibrary | Method :: getCellData | Exception desc : " + e.getMessage());
              TestSuiteDriver.glb_Boolean_testResult = false;
              return"";
              }
          }
